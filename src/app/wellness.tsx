  ...
  return (
    <AppScreen>
      ...
      <View style={styles.section}>
        ...
        <Card>
          <View style={styles.row}><View style={{ flex: 1, gap: 3 }}><Heading size="small">🏋️ Harbor Athletic Club</Heading><Body secondary>{gymMember ? 'Your $780/year membership includes visits and auto-renews annually while liquid cash can cover it.' : 'Use a $25 day pass, or join for $780/year. Memberships auto-renew until cancelled.'}</Body></View><StatusPill tone={gymMember ? 'success' : 'neutral'}>{gymMember ? 'Member · auto-renew' : '$25/visit'}</StatusPill></View>
          <View style={styles.actions}>
