    ...
    <AppScreen>
      ...
      {current ? (
        <Card accent>
          ...
          <View style={styles.stats}><Stat label="Grades" value={Math.round(current.recordedGrade).toString()} /><Stat label="Knowledge" value={Math.round(current.knowledgeGain).toString()} /><Stat label="Network" value={Math.round(current.network).toString()} /><Stat label="Tuition / yr" value={formatMoney(annualTuition, true)} /></View>
            ...
            <>
              <Card style={{ backgroundColor: colors.surface }}>
                ...
                {tuitionBalance > 0 ? <View style={styles.actions}>
                  <EngineActionButton title="Pay $500" action={{ verb: 'education.pay_tuition', targetIds: [current.id], parameters: { amountCents: 50_000 } }} style={{ flex: 1 }} />
                  <EngineActionButton title="Pay balance" action={{ verb: 'education.pay_tuition', targetIds: [current.id], parameters: { amountCents: tuitionBalance } }} tone="accent" style={{ flex: 1 }} />
