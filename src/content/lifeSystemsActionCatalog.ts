...
export const LIFE_SYSTEM_ACTION_CATALOG: ActionDefinition[] = [
  ...
  { id: 'business.withdraw_funds', domain: 'business', label: 'Take owner distribution', summary: 'Move distributable company cash to personal cash while preserving an operating runway.' },
